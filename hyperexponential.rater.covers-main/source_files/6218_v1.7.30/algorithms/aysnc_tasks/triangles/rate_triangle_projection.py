...
def rate_triangle_projection(hxd):
    ...
    if (bi_triangle_status or (override_triangle_active and override_triangle_valid))   and tri_3_status:
        ...
        tf_df = hx.params.table_rule_tail_factor
        ...
        weight_df                       = hx.params.table_rule_pattern_weight
    ...
    bench_all_class_idf_df      = hx.params.table_afbdevelopmentpatternsoc if tri.benchmark_use_occurrence else hx.params.table_afbdevelopmentpatterns
