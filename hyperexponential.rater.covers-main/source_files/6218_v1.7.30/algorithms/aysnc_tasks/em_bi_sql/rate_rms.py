...
def rate_rms(hxd):
    ...
    edm_prem = pd_df_from_hx_list(cds.rms.edm_prem)

    bordereaux_total_prem = edm_prem.values[0,0]
    ...
    #rms uplift
    uplift_df               = hx.params.table_rms_uplift
    ...
    edm_df['ws_loss_amount_raw'] = edm_df['ws_loss_amount'].fillna(0)
    edm_df['eq_loss_amount_raw'] = edm_df['eq_loss_amount'].fillna(0)
    ...
    output_columns= ['probability','return_period','return_period_label','ws_loss_amount_raw','eq_loss_amount_raw','ws_loss_amount','eq_loss_amount','all_peril_calc_at_edm_fx','all_peril_calc_at_acc_fx','all_peril_selected_at_acc_fx']
    ...
    empty_prem = True if(bordereaux_total_prem is None) else False 
    ...
    edm_sum.ws_loss_amount.aal_raw      =  0  if empty_aal else edm_summary_df.loc[edm_summary_df['return_period_text'] == "AAL",    'ws_loss_amount_raw'].iat[0]
    ...
    edm_sum.ws_loss_amount.prem         =  0  if empty_prem else  bordereaux_total_prem
    ...
    edm_sum.eq_loss_amount.aal_raw          =  0  if empty_aal else edm_summary_df.loc[edm_summary_df['return_period_text'] == "AAL",    'eq_loss_amount_raw'].iat[0]
    ...
    edm_sum.eq_loss_amount.prem         =  0  if empty_prem else  bordereaux_total_prem
    ...
    edm_sum.all_peril_calc_at_edm_fx.fxrate    =   edm_sum.eq_loss_amount.fxrate if edm_sum.ws_loss_amount.fxrate == 0 else edm_sum.ws_loss_amount.fxrate
    edm_sum.all_peril_calc_at_edm_fx.aal_raw          =  0  if empty_aal else edm_sum.ws_loss_amount.aal_raw   +   edm_sum.eq_loss_amount.aal_raw  
    ...
    edm_sum.all_peril_calc_at_edm_fx.prem         =  0  if empty_prem else bordereaux_total_prem
    ...
    edm_sum.all_peril_calc_at_edm_fx.gross_lr_pre_adj     =  0  if (empty_aal or (edm_sum.all_peril_calc_at_edm_fx.prem==0)) else edm_sum.all_peril_calc_at_edm_fx.aal_raw     / edm_sum.all_peril_calc_at_edm_fx.prem
    ...
    edm_sum.all_peril_calc_at_acc_fx.aal_raw          =  0  if empty_aal else (   edm_sum.ws_loss_amount.aal_raw * edm_sum.ws_loss_amount.fxrate
                                                                            + edm_sum.eq_loss_amount.aal_raw * edm_sum.eq_loss_amount.fxrate)
    ...
    edm_sum.all_peril_calc_at_acc_fx.prem         =  0  if empty_prem else (   bordereaux_total_prem * edm_sum.all_peril_calc_at_edm_fx.fxrate)
    ...
    edm_sum.all_peril_calc_at_acc_fx.gross_lr_pre_adj     =  0  if (empty_aal or (edm_sum.all_peril_calc_at_acc_fx.prem==0)) else edm_sum.all_peril_calc_at_acc_fx.aal_raw     / edm_sum.all_peril_calc_at_acc_fx.prem
    ...
    edm_sum.all_peril_selected_at_acc_fx.aal_raw      =  max(0,edm_sum.all_peril_override_at_acc_fx.aal_raw or 0)       if cds.rms.use_override else edm_sum.all_peril_calc_at_acc_fx.aal_raw 
    ...
    edm_sum.all_peril_selected_at_acc_fx.gross_lr_pre_adj     =  max(0,edm_sum.all_peril_override_at_acc_fx.gross_lr or 0)  if cds.rms.use_override else edm_sum.all_peril_calc_at_acc_fx.gross_lr_pre_adj
