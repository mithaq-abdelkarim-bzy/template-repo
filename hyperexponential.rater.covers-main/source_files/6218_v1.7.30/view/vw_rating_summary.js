...
function vw_rating_summary(scale) {
  return (
    <HX.Page title="Rating Summary" fullWidth={true} viewScale={0.67} shownBy="/model_state/show_after_landing_page">

      <HX.Section title="Case Pricing Inputs" shownBy="/cds/rating_summary/kpi/case_priced/show_case_pricing_input_section">
        <HX.Pane flow="down" stretch>
          <HX.Table
            title="Case Priced Inputs"
            data={[
              null
              , { datum: "case_priced", maxWidth: 140 }
            ]}
            fields={[
              "gg_att_ulr"
              , "gg_lrg_ulr"
      ...
      <HX.Section title="Exposure Rating Summary" shownBy="cds/show_hide/page/show_sov">
        <HX.Pane>
          <HX.Table title="Exposure Rating Summary"
            data={[
              null,
              { datum: "att_and_large", maxWidth: 140 },
              { datum: "cat", maxWidth: 140 }
            ]}
            fields={["pre_uw_adj_gn_ulr"]}
      ...
      <HX.Section title="Blended Summary" shownBy="cds/show_hide/page/show_sov">
        <HX.Pane>

          <HX.Table title="Exposure / Experience Rating Weights"
            data={[
              null,
              { datum: "exposure_rating", maxWidth: 140 },
              { datum: "experience_rating", maxWidth: 140 }
            ]}
            fields={["pre_uw_adj_gn_ulr", null, "sugg_weight", "sel_weight"]}
            with="cds/exposure_experience_weights"
            kb-interactive
            transpose
          />
          <HX.Collection fields={["gn_final_ulr", null, null, null, null, null, null]} with="cds/exposure_experience_weights" numCols={7} />
        </HX.Pane>
