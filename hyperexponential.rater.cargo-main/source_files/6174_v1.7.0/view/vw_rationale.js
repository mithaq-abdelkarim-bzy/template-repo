...
function vw_rationale(scale) {
  return (
    <HX.Page title="Rationale" fullWidth={false} viewScale={scale} shownBy="cds/cover_selection/is_selected">
      ...
      {/* <HX.Section title="Debug">
        <HX.Collection fields={["debug_str"]} horizontal />
      </HX.Section> */}
    </HX.Page>
  )
}
