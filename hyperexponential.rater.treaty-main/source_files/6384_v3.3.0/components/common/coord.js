  ...
  series: HX.PropTypes.arrayOfType(
    HX.PropTypes.oneOfType([
      HX.PropTypes.objectOfType({
        ...
        seriesColor: HX.PropTypes.string.optional,
        seriesLineType: HX.PropTypes.string.optional,
        seriesMode: HX.PropTypes.string.optional,
    ...
    seriesEntry.seriesList
      ? {
        ...
        nodes: {
          ...
          color: seriesEntry.seriesColor
            ? { type: "const", value: seriesEntry.seriesColor }
            : { type: "const", value: undefined },
          lineType: seriesEntry.seriesLineType
            ? { type: "const", value: seriesEntry.seriesLineType }
            : { type: "const", value: undefined },
          mode: seriesEntry.seriesMode
            ? { type: "const", value: seriesEntry.seriesMode }
            : { type: "const", value: undefined },
        ...
        ? entry.elements.map(
          (seriesElement) => seriesElement
            ? ({
              ...
              color: getNodeValue(seriesElement.nodes.color),
              mode: getNodeValue(seriesElement.nodes.mode),
              lineType: getNodeValue(seriesElement.nodes.lineType),
        ...
        : [
          {
            label:
              ...
              `Series ${seriesIndex}`,
            color:
              getNodeValue(entry.color),
            mode:
              getNodeValue(entry.mode),
            lineType:
              getNodeValue(entry.lineType),
            points: entry.points
