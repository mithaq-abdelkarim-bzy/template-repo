    ...
    return hx.Structure(children={
        ...
        "cds": hx.Structure(view={"label": "cds"}, children={
            ...
            "layers": hx.List(mode="input", max_element_count=6, view={"label": "Layers"}, children={
                ...
                "quoted_premium": hx.Float(mode="input", default=0, async_input=["rarc_task"], optionality="required", view={"label": "Gross Quoted Premium", "format": {"thousandSeparated": True, "mantissa": 0}, "options": {"read_only": {"read_only": True}}}),
