        ...
        <HX.With context={{ type: "list", path: "cds/layers", index: n }}>
          <HX.Collection
            ...
            fields={[
              "status.read_only",
              "section_reference",
              { field: "brokerage.read_only", shownBy: "/non_cds/cover_details/is_brokerage_all_layers_not" },
              { field: "/cds/rating_factors/cover_details/brokerage_all_layers/brk.read_only", shownBy: "/non_cds/cover_details/is_brokerage_all_layers" },
              "written_line",
            ]}
          />
          <HX.Collection
