      ...
      <HX.With context={{ type: "list", path: "cds/layers", index: 0 }}>
        <HX.Section title="Account Details">
          ...
          <HX.Pane>
            ...
            <HX.Collection fields={["quota_share_flag", "/hx_core/premium_currency", "/cds/standard_fields/is_renewal"]} horizontal />
          </HX.Pane>
        </HX.Section>
        <HX.Section title="Quota Share Information" shownBy="quota_share_flag">
          <HX.Pane>
            <HX.Collection fields={["is_follow", "beazley_share"]} horizontal />
            <HX.Collection fields={["lead_insurer", "participating_insurer"]} horizontal />
            <HX.Collection fields={["lead_limit", "lead_premium"]} horizontal shownBy="is_follow" />
          </HX.Pane>
        </HX.Section>
