    ...
    objects.push(
      <HX.Section title={"Renewal"} shownBy={"cds/rate_change/show_layer_" + (n + 1)} >
        ...
        <HX.With context={{ type: "list", path: "cds/layers", index: n }}>
          ...
          <HX.Pane>
            <HX.Table
              data={["premium_policy_term_100pct", "premium_policy_term_beazley_share", "written_line"]}
          ...
          <HX.Pane shownBy="/cds/rate_change/rarc_calcs_show" >
            ...
            <HX.Pane>
              <HX.Table shownBy="/cds/standard_fields/is_rater_priced"
                ...
                fields={[{ field: "model_calculated", width: 125 }, { field: "uw_selected", width: 125 }, { field: "comments", width: 300 }]}
                with="rate_change"
                kb-interactive
              />
            </HX.Pane>
    ...
    <HX.Page title="Rate Change" fullWidth={false} shownBy="cds/standard_fields/is_renewal" >
      <HX.Section title="Fetch Expiring Policy">
        {/* <HX.With context={{ type: "list", path: "cds/layers", index: 0 }}>
          <HX.Collection fields={["rate_change/is_from_inputs_only"]} />
        </HX.With> */}
        <HX.Pane flow="right" >
        ...
        <HX.Pane>
          {/* <HX.Table
            title=""
            data={[{ datum: "cds/layers", width: 150 }]}
            fields={[{ field: "deal_status_record" }]}
            transpose
          /> */}
        </HX.Pane>
      </HX.Section>
