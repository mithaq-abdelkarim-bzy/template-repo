    ...
    return hx.Structure(children={
        ...
        "cds": hx.Structure(view={"label": "cds"}, children={
            ...
            "standard_fields": hx.Structure(view={"label": "Standard Fields"}, children={
                ...
                "is_rater_priced": hx.Bool(mode="output", async_input=["policy_to_excel_task"], view={"label": "Is Rater Priced"}),
            }),
            ...
            "policy_term": hx.Float(mode="output", async_input=["rarc_task"], view={"label": "Policy term (years)", "format": {"thousandSeparated": True, "mantissa": 1}}),
