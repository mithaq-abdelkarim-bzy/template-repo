...
function vw_loop_rating_insured_asset_summary(num_layers) {
  const objects = [];
...
function vw_rating_summary_layers_insured_asset(scale) {
  return (
    <HX.Page title="Rating Summary Layers Insured Assets" fullWidth={true} viewScale={0.90} shownBy="model_state/layer_ia_use">
      ...
      {vw_loop_rating_insured_asset_summary(max_layers())}
...
export { vw_rating_summary_layers_insured_asset };