...
function vw_loop_rate_change_layer(num_layers, num_coverages) {
  const objects = [];
...
function vw_rate_change_coverages() {
  return (
    <HX.Page title="Rate Change Coverages" fullWidth viewScale={1} shownBy="model_state/show_rate_change_coverage_no_ia_use" >
      <HX.Section title="Fetch Expiring Policy">
        ...
        <HX.Pane flow="right" >
          ...
          <HX.Button title="Calculate Rate Change" task="rarc_task_coverages" shownBy="cds/standard_fields/is_rater_priced" />
        </HX.Pane>
        <HX.Pane>
...
export { vw_rate_change_coverages };