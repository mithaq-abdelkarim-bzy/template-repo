...
function vw_rating_summary_coverages_insured_asset(scale) {
  return (
    <HX.Page title="Rating Summary Coverages Insured Assets" fullWidth={true} viewScale={0.90} shownBy="model_state/coverage_ia_use">
...
export { vw_rating_summary_coverages_insured_asset };