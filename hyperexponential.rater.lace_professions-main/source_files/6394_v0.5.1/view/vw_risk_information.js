  ...
  return (
    <HX.Page title="Risk Information" shownBy="model_state/show_after_landing_page">
      <HX.Section title="Account Details">
        <HX.Pane >
          <HX.Collection
            ...
            horizontal
          />
          <HX.Collection fields={["underwriter", null]} with="cds/standard_fields" horizontal />
      ...
      <HX.Section title="Broker Details">
        <HX.Collection fields={["cds/standard_fields/broker", null]} horizontal />
      </HX.Section>
      <HX.Section title="Coverage">
        <HX.Collection fields={["cds/profession", "cds/retro_date"]} horizontal />
        <HX.Collection fields={[{ field: "cds/lawyers_num_attorneys_full", infoBy: "cds/hover_info/num_att_full" },
        { field: "cds/lawyers_num_attorneys_fte", infoBy: "cds/hover_info/num_att_fte" }
        ]}
          horizontal shownBy="cds/profession_lawyers_bool" />
      </HX.Section>
