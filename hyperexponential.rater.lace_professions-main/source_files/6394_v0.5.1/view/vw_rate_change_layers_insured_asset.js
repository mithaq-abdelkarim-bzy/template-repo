...
function vw_loop_rate_change_layers_insured_asset(num_layers, num_coverages) {
  const objects = [];
            ...
            <HX.Pane flow="right" >
              <HX.Pane >
                <HX.Table
                  ...
                  fields={[{ field: "expiring", width: 130 }, { field: "expiring_revalued", width: 130, shownBy: "show_expiring_revalued" }, { field: "renewal", width: 130 }]}
                  with="rate_change"
                />
...
function vw_rate_change_layers_insured_asset() {
  return (
    <HX.Page title="Rate Change Layers Insured Assets" fullWidth viewScale={1} shownBy="model_state/show_rate_change_layer_ia_use">
      <HX.Section title="Fetch Expiring Policy">
        ...
        <HX.Pane flow="right" >
          ...
          <HX.Button title="Calculate Rate Change" task="rarc_task_insured_asset" shownBy="cds/standard_fields/is_rater_priced" />
        </HX.Pane>
        <HX.Pane>
      ...
      {vw_loop_rate_change_layers_insured_asset(max_layers())}

    </HX.Page >
  )
}
export { vw_rate_change_layers_insured_asset };