...
def sch_risk_information(cds):
    ...
    cds.override_node_properties("cds/standard_fields/benchmark_class", {"options":["Large Client Professional"], "default": "Large Client Professional"})
    cds.override_node_properties("cds/standard_fields/broker", {"options":["Aon","CJ Coleman","Gallaghers","Howden","Lockton","Marsh","New Dawn","Paragon","Tysers","Willis","Other"], "default": None})    
