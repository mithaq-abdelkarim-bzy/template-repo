...
def sch_experience_rating(cds):
    ...
    # cds.extend_node_rater_defined("cds/experience_rating", {
    #     "claims_summary": hx.List(mode="output", children={
    #         "policy_year": hx.Int(mode="output", view={"label": "Policy Year"}),
    #         "revalued_notional_revenue": hx.Float(mode="output", view={"label":"Revalued Notional Revenue"}),
    #         "revalued_notional_revenue_weighted": hx.Float(mode="output", view={"label":"Weighted Revalued Notional Revenue"}),
    #         "pcnt_developed": hx.Float(mode="output", view={"label":"% Developed"}),
    #         "gu_incurred": hx.Float(mode="output", view={"label":"Incured GU (USD)"}),
    #         "gu_inflated": hx.Float(mode="output", view={"label": "Inflated GU (USD)"}),
    #         "ql_inflated_incurred": hx.Float(mode="output", view={"label":"Inflated Incurred (USD)"})
    #     })
    # })
    cds.extend_node_rater_defined("cds/experience_rating/claims", {
        ...
        "currency": hx.Str(mode="input", options_table="table_input_currency", default_index=0, options_column="ccy", view={"label": "Currency"}), # will need to link this to a currency table etc.
