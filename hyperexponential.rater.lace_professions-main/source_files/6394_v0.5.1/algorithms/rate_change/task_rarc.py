...
from algorithms.rate_change.simulation_reprice import (
    ...
    validate_transient_simulation_inputs,
)
...
def task_rarc_layer(hxd, progress):
    ...
    rc = RateChangeLib(
        ...
        async_tasks=[recalculate_exposure_rates_for_rate_change],  # Pass the actual tasks name as a variable, not a string
        pre_reprice_validation=validate_transient_simulation_inputs,
