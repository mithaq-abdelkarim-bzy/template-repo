...
function vw_pricing(scale) {
  return (
    ...
    <HX.Page title="Structure & Pricing" fullWidth={true} viewScale={scale} shownBy="model_state/layer_no_ia_use">
      ...
      <HX.Section title="Policy Structure (USD)" defaultCollapsed={false}>
        ...
        <HX.Table
          ...
          fields={[
            ...
            null,
            { field: "experience_weighting", width: 170 },
      ...
      <HX.Section title="Additional Policy Structure (USD)" defaultCollapsed={false}>
        <HX.Table
          data={[
            {
      ...
      <HX.Section title="AvE Chart" defaultCollapsed={false}>
        <HX.XYChart
          data={["data", "data"]}
