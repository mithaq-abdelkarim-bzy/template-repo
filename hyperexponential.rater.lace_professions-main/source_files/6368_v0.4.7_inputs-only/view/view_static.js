  ...
  return (
    <HX.Root>
      ...
      <HX.Page title="Exposure Details"
        ...
        <HX.Section title="Chart - Model Loss Cost by Revenue"
      ...
      <HX.Page title="Territory"
        ...
        <HX.Section title="Options"
          defaultCollapsed={false}>
          <HX.Collection fields={[
            "bool_individual_country_level",
            "bool_individual_state_level",
            "is_percentage_bool",
            null
          ]}
            horizontal={true}
        ...
        <HX.Section title="Chart - Loss Cost by Territory"
          defaultCollapsed={false}>
      ...
      <HX.Page title="Client Details - Lawyers"
        ...
        <HX.Section title="Chart - Loss Cost by Area of Practice"
          defaultCollapsed={false}>
          <HX.CategoryChart data={[
      ...
      <HX.Page title="Client Details - AEC "
        ...
        <HX.Section title="Chart - Loss Cost by Project Type"
          defaultCollapsed={false}>
          <HX.CategoryChart data={[
      ...
      <HX.Page title="Structure & Pricing"
        ...
        <HX.Section title="Retention"
          ...
          <CustomComponent notesPath="cds/retention_split_uw_comments"
            ...
            label="Retention Split Comments"
            width="400px"
            marginTop="4px"
            marginBottom="4px"
            autosave={true} />
        </HX.Section>
        <HX.Section title="Policy Structure (USD)"
          defaultCollapsed={false}>
          <HX.Collection fields={[
            {
          ...
          <HX.Table data={[
            ...
            null,
            {
              "field": "uw_experience_weighting",
              "infoBy": "hover_info/uw_experience_weighting",
              "width": 170
            },
            {
              "field": "blended_uw_net_rate",
              "infoBy": "hover_info/blended_uw_net_rate",
              "width": 170
            },
            {
              "field": "benchmark_premium_uw_view",
              "infoBy": "hover_info/benchmark_premium_uw_view",
              "width": 170
            },
            null,
            {
        ...
        <HX.Section title="Additional Policy Structure (USD)"
          defaultCollapsed={false}>
          <HX.Table data={[
            {
              "datum": "layers_addl",
        ...
        <HX.Section title="Exposure Simulation Results - No UW Adj"
          defaultCollapsed={false}>
          <HX.Table data={[
            {
              "datum": "layers",
            ...
            {
              "field": "sim_output_no_uw_adj/exposure_premium",
              "width": 300
            },
            {
              "field": "sim_output_no_uw_adj/average_freq",
              "width": 300
            },
            {
              "field": "sim_output_no_uw_adj/average_defense_cost_freq",
              "width": 300
            },
            {
              "field": "sim_output_no_uw_adj/layer_exhaust_prob",
              "width": 300
            }
          ]}
            with="cds"
