  ...
  return (
    <HX.Page title="Territory" fullWidth={true} viewScale={scale} shownBy="model_state/show_after_landing_page">
      ...
      <HX.Section title="Options" defaultCollapsed={false}>
        <HX.Collection fields={["bool_individual_country_level", "bool_individual_state_level", "is_percentage_bool", null]}
          horizontal
      ...
      <HX.Section title="Summary" defaultCollapsed={false}>
        ...
        <HX.Table
          ...
          fields={[
            { field: "year_0_pcnt", width: 130, labelBy: "summary_year_total_labels/year_0", shownBy: "is_percentage_bool", infoBy: "/cds/hover_info/territory_policy_year" },
            ...
            { field: "year_0_value", width: 130, labelBy: "summary_year_total_labels/year_0", shownBy: "is_percentage_bool_not" },
      ...
      <HX.Section title="Chart - Loss Cost by Territory" defaultCollapsed={false}>
        <HX.CategoryChart
          data={["united_kingdom",
            "australia",
            "canada",
