...
from algorithms.rate_constants import get_territory_groups, get_individual_countries, get_individual_countries_count, get_states_count
        ...
        "territory": hx.Structure(children={
            ...
            "summary": hx.Structure(children={
                ...
                **{f"{key}_country_sum": hx.Structure(children={
                    "year_0_pcnt": hx.Float(mode="output", view={"label": "year_0", "format": utils.percent_format(1)}),
                    "year_1_pcnt": hx.Float(mode="output", view={"label": "year_1", "format": utils.percent_format(1)}),
                    "year_2_pcnt": hx.Float(mode="output", view={"label": "year_2", "format": utils.percent_format(1)}),
                    "year_3_pcnt": hx.Float(mode="output", view={"label": "year_3", "format": utils.percent_format(1)}),
                    "year_4_pcnt": hx.Float(mode="output", view={"label": "year_4", "format": utils.percent_format(1)}),
                    "year_5_pcnt": hx.Float(mode="output", view={"label": "year_5", "format": utils.percent_format(1)}),
                    ...
                    "weighted": hx.Float(mode="output", view={"label": "Weighted % Split", "format": utils.percent_format(1)}),
            ...
            "individual_countries": hx.List(
                ...
                children={
                    ...
                    "year_0_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_0", "format": utils.percent_format(1)}),
                    "year_1_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_1", "format": utils.percent_format(1)}),
                    "year_2_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_2", "format": utils.percent_format(1)}),
                    "year_3_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_3", "format": utils.percent_format(1)}),
                    "year_4_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_4", "format": utils.percent_format(1)}),
                    "year_5_pcnt": hx.Float(mode="input", default=0, optionality="optional", view={"label": "year_5", "format": utils.percent_format(1)}),
