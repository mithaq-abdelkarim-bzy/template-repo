...
import { vw_risk_characteristics } from "view/vw_risk_characteristics";
...
import { vw_modifiers_breakdown_page } from "view/vw_modifiers_breakdown";
...
function HXModel() {
  ...
  return (
    <HX.Root>
      ...
      {vw_risk_characteristics(scale)}
      {vw_pricing(scale)}
      {vw_modifiers_breakdown_page(scale)}
