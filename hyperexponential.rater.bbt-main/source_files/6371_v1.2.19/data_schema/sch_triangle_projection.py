...
def sch_triangle_projection(cds):
    ...
    cds.extend_node_rater_defined("cds", {
        ...
        "triangle_projection": hx.Structure(children={
            "override_triangle":                hx.Bool( mode="input",   view={"label": "Use Override Triangle?"},                   default=False,  ),
            "override_triangle_date":           hx.Date( mode="input",   view={"label": "Enter Date of Override Triangle:"},         default=None, optionality="optional"),
            "override_triangle_date_used":      hx.Date( mode="input",   view={"label": "Date of Override Triangle used: "},         default=None, optionality="optional"),
            "override_triangle_years":          hx.Float(mode="input",   view={"label": "Enter Number of Years:"},                   default=5),
            "assign_override_triangle_status":  hx.Str(  mode="output",  view={"label": "Override Triangle Status"} ),
            "async_override_triangle_status":   hx.Str(  mode="output",  view={"label": "Override Triangle Last Setup Status"} ),


            "tri_exclusions_setup_task_status": hx.Str(mode="output",   view={"label": "Exclusions Triangle Task Status"} ),
            ...
            "tri_2_manual_input":   hx.Triangle(mode="input"),
            ...
            "tri_3a_exclusions":   hx.Triangle(mode="input"),
