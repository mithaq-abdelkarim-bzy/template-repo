...
def edm_fetch(hxd,progress):
    ...
    query1 = f"""
        ...
        WHERE left([PortNum],6) LIKE '{index_ref}' 
    """
    columns1 = ['portnum']
    ...
    query2 = f"""
        ...
        WHERE left(a.[PortNum],6) LIKE '{index_ref}' 
...
def query_edm_database(query, columns):
    ...
    host = hx.secrets.exposuremanagement_host_prd                   ### UAT: hx.secrets.exposuremanagement_host_uat;        Prod:   hx.secrets.exposuremanagement_host_prd
    database_name = "Property_data"
    user = hx.secrets.exposuremanagement_login_prd                  ### UAT: hx.secrets.exposuremanagement_login_uat;       Prod:   hx.secrets.exposuremanagement_login_prd
    password = hx.secrets.exposuremanagement_password_prd           ### UAT: hx.secrets.exposuremanagement_password_uat;    Prod:   hx.secrets.exposuremanagement_password_prd
