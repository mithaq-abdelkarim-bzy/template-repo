...
def sch_rater_defined(cds):
    ...
    cds.extend_node_rater_defined("cds/layers/coverages/property", property_dict)
    cds.extend_node_rater_defined("cds/layers/coverages/liability", liability_dict)
    cds.extend_node_rater_defined("cds/layers/coverages/construction", construction_dict)
    cds.extend_node_rater_defined("cds/layers/coverages/total", totals_dict)
