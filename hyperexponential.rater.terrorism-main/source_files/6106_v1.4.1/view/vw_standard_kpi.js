      ...
      <HX.Section title={"Summary Layer " + (n + 1)} defaultCollapsed >
        ...
        <HX.With context={{ type: "list", path: "cds/layers", index: n }}>
          ...
          <HX.Collection
            ...
            numCols={2}
            fields={[
              { field: "quoted_premium", labelBy: "premium_label", shownBy: "/cds/standard_fields/is_rater_priced" },
              { field: "quoted_premium_case_priced", labelBy: "premium_label", shownBy: "/cds/standard_fields/is_case_priced" },
              null,
              "technical_premium",
              "benchmark_premium",
              "tpi",
