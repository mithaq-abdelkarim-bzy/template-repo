...
class ExportAdvancedFeaturesData:

    def __init__(
            self, 
            output_file_path="/workspace/editing/test_cases/exported_advanced_features_data.csv",
            module_name = "advanced_features",
...
eafd = ExportAdvancedFeaturesData()
eafd.data_schema_static_to_csv()