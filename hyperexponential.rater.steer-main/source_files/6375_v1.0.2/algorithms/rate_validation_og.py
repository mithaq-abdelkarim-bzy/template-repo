...
def rate_validations(hxd):
    ...
    # Validation for Steer Experience Rating exposure input
        ...
        if ms.has_run_steer_format_data:
            ...
            are_inputs_same = (ms.data_used_in_steer_format_data_task == str(task_data_dict)) and (ms.layer_data_used_in_steer_format_data_task == str(task_layer_data_list)) and (ms.raw_data_used_in_steer_format_data_task == str(task_raw_data_list)) and (ms.expo_assumptions_data_used_in_steer_format_data_task == str(task_expo_assumptions_list))
