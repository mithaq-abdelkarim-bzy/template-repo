...
def steer_format_raw_data(hxd, progress):
    ...
    # Save compact fingerprints in model_state instead of large stringified data objects
    ms.data_used_in_steer_format_data_task = task_data_hash
    ms.layer_data_used_in_steer_format_data_task = task_layer_data_hash
    ms.raw_data_used_in_steer_format_data_task = task_raw_data_hash
    ms.expo_assumptions_data_used_in_steer_format_data_task = task_expo_assumptions_hash
