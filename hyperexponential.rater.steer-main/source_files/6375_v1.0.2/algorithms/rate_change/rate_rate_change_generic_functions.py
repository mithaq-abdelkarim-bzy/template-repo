...
def assign_rc_nodes(rc_source_data, rc_data):
    ...
    if not RARC_INSURED_ASSET_USE:
        ...
        rc_data.rate.renewal = rc_source_data.rate
    ...
    # Node only aplicable to premium calculated at a layer or coverage level
        ...
        rc_data.rate.expiring = (rc_data.expiring_policy_info.expiring_rate or 0)
    ...
    rc_data.rate.expiring_revalued = rc_data.rate.expiring # same as expiring
