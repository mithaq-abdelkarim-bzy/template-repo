...
# The following code set out examples of how to use the built in cds functions. Please remove these example nodes for live models. 
...
def sch_example_code(cds):
    ...
    '''
    NOTE use the override function to override the properties of cds variables for example adding async tasks, changing default values or linking a dropdown
    to a parameter table. 
    '''
