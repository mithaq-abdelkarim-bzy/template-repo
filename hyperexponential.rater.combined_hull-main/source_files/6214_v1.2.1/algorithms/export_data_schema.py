...
class ExportDataSchema:
    ...
    def __init__(
            ...
            csv_str = '"Path","Name","Type","Mode","Optionality","Label","Default Value"\n',
...
\""")"""
    ...
    def data_schema_static_to_csv(self):
        ...
        sch = getattr(module, data_schema_module_name)()
    ...
    def __recurssive_schema(self, ppath, sch):
        for cpath in sch.children:
            ...
            csv_str = csv_str + ',"' + mode + '","' + optionality + '","' + label + '","' + str(default_val) + '"' + '\n'
            self.__csv_str += csv_str
        return ppath
