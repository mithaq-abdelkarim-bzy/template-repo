...
def sch_rate_change(cds):
    ...
    def expiring_and_renewal():
        ...
        nodes_labels = [
                    ...
                    "Gross Benchmark Premium (UW Adjusted pre NMP)",
    ...
    rc_fields_case_priced = {
        ...
        "comments": hx.Str(mode="input", default="", view={"label": "Comment"}, async_output=[{"task": "start_renewal_task", "reset": False}])
    }
    rc_temp_storage = {
    ...
    cds.extend_node_rater_defined("cds/layers/rate_change", {
        ...
        **{
            cvg: hx.Structure(view=cvg_view, children={
                **{change: hx.Structure(view=rc_view, children={
                    "model_calculated": hx.Float(mode="output", async_output=[] if change=="rate_change" else ["rarc_task"], view={"label": "Model", "format": percent_format(1)}),
                    "uw_selected": hx.Float(mode="output" if change=="rate_change" else "override", view={"label": "UW Selected", "format": percent_format(1)}),
                ...
                "risk_adjusted_rate_change": hx.Structure(view={"label": "Underwriter Selected"}, children=rc_fields_rater),
                "risk_adjusted_rate_change_case_priced": hx.Structure(view={"label": "Underwriter Selected"}, children=rc_fields_case_priced),
        ...
        **expiring_and_renewal(),
        ...
        "temp_storage": hx.Structure(children=rc_temp_storage) # To store premiums when running the RARC calculation        
    })
