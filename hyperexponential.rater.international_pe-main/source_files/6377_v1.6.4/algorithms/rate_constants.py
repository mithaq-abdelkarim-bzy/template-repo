...
def discipline_list():
    discipline_name = ["eo_ae_architecture_commercial",
    ...
    discipline_full_name = ["cds/exposure/granular/" + s + "/input_pct" for s in discipline_name]
    return(discipline_full_name)

def ae_operation_list():
    ae_operation_name = [
    ...
    ae_operation_full_name = ["cds/exposure/granular/" + s + "/input_pct" for s in ae_operation_name]
    return(ae_operation_full_name)

def mediatech_industry_list():
    mediatech_industry_name = [
    ...
    mediatech_industry_full_name = ["cds/exposure/granular/" + s + "/input_pct" for s in mediatech_industry_name]
    return(mediatech_industry_full_name)

def mediatech_schedule_list():
    mediatech_schedule_name = [
    ...
    mediatech_schedule_name = ["mediatech_" + item for item in mediatech_schedule_name]
    mediatech_schedule_full_name = ["cds/modifiers/" + s + "/input_value" for s in mediatech_schedule_name]
    return(mediatech_schedule_full_name)
