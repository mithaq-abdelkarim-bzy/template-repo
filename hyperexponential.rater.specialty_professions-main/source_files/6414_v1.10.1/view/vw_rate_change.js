...
import { max_layers, layer_labels } from "view/vw_constants";
...
function vw_loop_rate_change_layer(num_layers) {
  ...
  for (let n = 0; n < num_layers; n++) {
    objects.push(
      <HX.Section title={"Renewal: " + layer_labels[n]} defaultCollapsed shownBy={"cds/rate_change/show_layer_" + (n + 1)} >
        <HX.With context={{ type: "list", path: "cds/layers", index: n }}>
          <HX.Pane>
            ...
            <HX.Collection fields={[{ field: "rate_change/expiring_layer", labelBy: "rate_change/expiring_layer_info" },
              null, null, null, null]} horizontal />
            {/* <HX.Collection fields={["rate_change/expiring_layer_info", null, null, null, null]} horizontal /> */}
            <HX.Table
              data={[
                "currency",
            ...
            <HX.Collection title="Final Rate Change"
              fields={[
                ...
                { field: "rate_change/risk_adjusted_rate_change_case_priced/uw_selected", shownBy: "/cds/standard_fields/is_case_priced" },
                null, null
              ]}
              horizontal
            />
  ...
  return (
    <HX.Page title="Rate Change" fullWidth={false} shownBy="model_state/show_rate_change_layer_no_ia_use" >
      <HX.Section title="Fetch Expiring Policy">
        ...
        {/* <HX.Section title="Notifications" shownBy="page_info/rate_change/notification_flag">
          <HX.Pane>
            <HX.Notes field="page_info/rate_change/notification_text" />
          </HX.Pane>
        </HX.Section> */}
      </HX.Section>
