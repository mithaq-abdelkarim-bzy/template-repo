...
def rate_experience_rating(hxd):
    ...
    claims_df['currency_calculated'] = hxd.cds.ccy    #need to calculate a selected column to use later in the calcs
    ...
    slip_fx_rate = table_currency[table_currency["currency"] == hxd.cds.ccy]["exchange_rate"].iloc[0]
