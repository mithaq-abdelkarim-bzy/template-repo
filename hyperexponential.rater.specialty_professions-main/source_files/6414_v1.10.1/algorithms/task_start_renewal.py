...
def task_start_renewal(hxd, progress):
    ...
    if not hxd.cds.standard_fields.insured_name:
        ...
        # Clear any section references and statuses
        hxd.cds.primary.status_view = None
        hxd.cds.primary.section_reference_view = None
    ...
    rc.has_rarc_run = False
    rc.has_rarc_not_run = True
