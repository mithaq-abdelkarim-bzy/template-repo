...
def sch_rate_change(cds):
    ...
    cds.extend_node_rater_defined("cds/layers/rate_change", {
        ...
        "risk_adjusted_rate_change_case_priced": hx.Structure(view={"label": "Underwriter Selected"}, children={
            "uw_selected": hx.Float(mode="override", view={"label": "Final Risk Adjusted Rate Change", "format": percent_format()}),
    ...
    cds.override_node_properties("cds/ccy", {"async_input": [rarc_task_name],"async_output": [{"task": rarc_task_name, "reset": False}]})
